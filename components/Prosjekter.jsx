                ...
                >
                    {projects.map((project) => (
                        ...
                        >
                            <div className='relative w-full h-[440px] flex items-center justify-center bg-transparent'>
                                ...
                                <div className='absolute w-full h-full flex items-center justify-center z-0'>
                                    ...
                                    <Image
                                        ...
                                        className='lg:w-3/5 md:w-2/3 h-auto opacity-100 transition-opacity duration-500'
                                        width={200}
                                        height={200}
                                    />
                                </div>
                            ...
                            <div className='absolute inset-0 bg-cyan-950 flex justify-center flex-col text-white p-4 transition-opacity opacity-100 duration-700 sm:opacity-0 sm:group-[.swiper-slide-active]:opacity-90 z-10'>
                                {" "}
                                {/* Tekst får høyere z-index */}
